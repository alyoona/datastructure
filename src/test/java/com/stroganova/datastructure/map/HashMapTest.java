...
public class HashMapTest {
    ...
    public void testIterator() {
        ...
        for (HashMap.Entry<Object, String> entry : map) {
            actual.append(entry.getKey()).append(":").append(entry.getValue()).append(" ");
        }
        assertEquals(expected, actual.toString());
    }

    @Test
    public void testPutIfCollision() {
        Map<Object, String> map = new HashMap<>(2);
        assertEquals(null, map.put(14, "14"));
        assertEquals("14", map.get(14));
        assertEquals(null, map.put(0, "0"));
        assertEquals("0", map.get(0));
        assertEquals("14", map.put(14, "15"));
        assertEquals("15", map.get(14));
    }
